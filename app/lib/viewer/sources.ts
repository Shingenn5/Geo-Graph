export type Surface = "Natural" | "Bare Earth" | "Geology" | "Soil" | "Land cover" | "USGS relief";
export const SURFACES: Surface[] = ["Natural", "Bare Earth", "Geology", "Soil", "Land cover", "USGS relief"];
