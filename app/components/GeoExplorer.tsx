...
export default function GeoExplorer(){
  ...
  const surfaceSource=surfaceMode==="Natural"&&base==="topo"?"USGS topo + Mapterhorn elevation":surfaceMode==="Natural"&&aerialEnabled?"Esri + USGS aerial + Mapterhorn elevation":activeSurface.source;
